...
const partOfSpeech = {
  ...
  "prop.n.": "tstxo",
  "sbd.": "zeya fnetilìu",
  "vim.": "srunga'a kemlìu (kea -l/-t)",
  "vin.": "kemlìu (kea -l/-t)",
  "vtr.": "kemlìu (-l/-t)",
  "vtrm.": "srunga'a kemlìu tìlateme",
  ...
  list: {
    ...
    listMenu: {
      whatValues: [
        ...
        { value: "length", description: "ngimpup lìuä (ìle flldepam)" },
      ],
      condValues: {
        pos: [
